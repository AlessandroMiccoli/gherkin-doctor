...
public class FeatureReader {
     ...
     * </p>
     *
     * @param featureLocation the location of the feature file(s).
     * @return a list of {@link GherkinDocument} objects representing the parsed feature files
     */
    public List<GherkinDocument> read(String featureLocation) {
        val maybePaths = FileUtil.findPaths(featureLocation);
